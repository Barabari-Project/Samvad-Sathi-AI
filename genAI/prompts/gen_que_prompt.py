...
[
  {
    "category": "Technical",
    "difficulty": "Easy",
    "question": "Explain how the CSS Box Model works. What components make up an element's total width and height?",
    "hint": "Mention content, padding, border, margin and how they affect layout calculations"
  },
  {
    "category": "Technical",
    "difficulty": "Medium",
    "question": "How would you implement a responsive grid layout without using frameworks like Bootstrap? Describe your approach.",
    "hint": "Use CSS Grid/Flexbox properties like grid-template-columns, fr units, and media queries"
  },
  {
    "category": "Technical",
    "difficulty": "Hard",
    "question": "Walk through the browser's Critical Rendering Path. How would you optimize it for faster initial page loads?",
    "hint": "Cover DOM/CSSOM construction, render tree, layout, paint; mention async/defer, resource prioritization"
  },
  {
    "category": "Behavioral",
    "difficulty": "Easy",
    "question": "Describe a time you had to learn a new technology quickly for a project. What steps did you take?",
    "hint": "Structure using STAR: Specific resource, Timeline, Application, Result"
  },
  {
    "category": "Behavioral",
    "difficulty": "Medium",
    "question": "Tell me about a disagreement you had with a teammate regarding technical implementation. How was it resolved?",
    "hint": "Highlight active listening, objective criteria (e.g., performance metrics), and compromise"
  },
  {
    "category": "Behavioral",
    "difficulty": "Hard",
    "question": "You discover a critical bug minutes before a deployment deadline. What actions do you take?",
    "hint": "Discuss triage, stakeholder communication, and tradeoffs between delay vs. risk"
  },
  {
    "category": "Role-specific",
    "difficulty": "Easy",
    "question": "When would you choose React over vanilla JavaScript for a project? Provide examples.",
    "hint": "Compare component reusability, state management, and ecosystem tools"
  },
  {
    "category": "Role-specific",
    "difficulty": "Medium",
    "question": "How would you structure a reusable accessibility-compliant button component in React?",
    "hint": "Include ARIA roles, keyboard events, focus management, and PropTypes"
  },
  {
    "category": "Role-specific",
    "difficulty": "Hard",
    "question": "Design a real-time dashboard showing live analytics. Which frontend architecture patterns would you use?",
    "hint": "Discuss WebSocket integration, state normalization, throttling updates, and error fallbacks"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Easy",
    "question": "Your resume mentions an e-commerce dashboard project. What CSS techniques did you use for responsiveness?",
    "hint": "Reference specific methods like Flexbox breakpoints or relative units (em/rem)"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Medium",
    "question": "You listed TypeScript as a skill. How did it improve your Vue.js project at ABC Inc compared to plain JavaScript?",
    "hint": "Contrast type safety, refactoring ease, and error reduction with concrete examples"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Hard",
    "question": "Your resume states you improved load times by 30% at XYZ Corp. What specific frontend optimizations did you implement?",
    "hint": "Detail techniques like code splitting, lazy loading, or asset optimization tools"
  }
]

### 2. **2 Years Experience** (Junior-level)
[
  {
    "category": "Technical",
    "difficulty": "Easy",
    "question": "What are React hooks? Provide examples of useState and useEffect.",
    "hint": "Explain side-effect management and state preservation across re-renders"
  },
  {
    "category": "Technical",
    "difficulty": "Medium",
    "question": "Compare client-side rendering (CSR) vs. server-side rendering (SSR). When would you choose Next.js over plain React?",
    "hint": "Discuss SEO, TTI (Time to Interactive), and data-fetching tradeoffs"
  },
  {
    "category": "Technical",
    "difficulty": "Hard",
    "question": "Debug a memory leak in a SPA. What tools and strategies would you use?",
    "hint": "Mention Chrome DevTools heap snapshots, useEffect cleanup, and event listener removal"
  },
  {
    "category": "Behavioral",
    "difficulty": "Easy",
    "question": "How do you prioritize tasks when multiple features have tight deadlines?",
    "hint": "Reference frameworks like MoSCoW or effort/impact matrix"
  },
  {
    "category": "Behavioral",
    "difficulty": "Medium",
    "question": "Describe mentoring a junior developer. How did you ensure their understanding of complex code?",
    "hint": "Include knowledge transfer methods (pair programming, docs) and feedback loops"
  },
  {
    "category": "Behavioral",
    "difficulty": "Hard",
    "question": "You strongly disagree with an architectural decision from a senior engineer. How do you escalate your concerns?",
    "hint": "Emphasize data-driven arguments, prototypes, and respectful challenge"
  },
  {
    "category": "Role-specific",
    "difficulty": "Easy",
    "question": "What metrics would you monitor to improve a website's Core Web Vitals?",
    "hint": "Name LCP, FID, CLS; explain how they affect user experience"
  },
  {
    "category": "Role-specific",
    "difficulty": "Medium",
    "question": "Implement a dark/light theme switcher using CSS-in-JS. Handle persistence via localStorage.",
    "hint": "Use React context, ThemeProvider, and useEffect for syncing"
  },
  {
    "category": "Role-specific",
    "difficulty": "Hard",
    "question": "Design an offline-first mobile PWA for a news site. How would you handle data synchronization?",
    "hint": "Cover service workers, cache strategies (NetworkFirst), and conflict resolution"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Easy",
    "question": "Your resume shows Express.js experience. How did you use it to build REST APIs for your e-commerce dashboard?",
    "hint": "Describe route handlers, middleware (e.g., CORS), and error handling"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Medium",
    "question": "You used WebSockets for real-time updates in your portfolio project. What challenges did you face with connection stability?",
    "hint": "Discuss heartbeat mechanisms, reconnection logic, and fallback options"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Hard",
    "question": "Your resume cites 'Redux for state management'. Why did you choose it over Context API for the XYZ Corp project?",
    "hint": "Compare middleware (thunk/saga), debugging tools, and performance at scale"
  }
]
...
[
  {
    "category": "Technical",
    "difficulty": "Easy",
    "question": "What is the virtual DOM? How does it differ from the actual DOM?",
    "hint": "Explain diffing algorithms and batched updates"
  },
  {
    "category": "Technical",
    "difficulty": "Medium",
    "question": "Optimize a React app with heavy re-renders. What tools and techniques would you apply?",
    "hint": "Use React.memo, useCallback, React DevTools profiling, and code splitting"
  },
  {
    "category": "Technical",
    "difficulty": "Hard",
    "question": "Design a micro-frontend architecture. How would you handle shared dependencies and cross-app communication?",
    "hint": "Discuss module federation, versioning, and event-bus patterns"
  },
  {
    "category": "Behavioral",
    "difficulty": "Easy",
    "question": "How do you handle conflicting feedback from product and engineering teams on UI implementation?",
    "hint": "Describe facilitating workshops with prototypes to align goals"
  },
  {
    "category": "Behavioral",
    "difficulty": "Medium",
    "question": "Share an example where you advocated for technical debt reduction. How did you justify the ROI?",
    "hint": "Quantify impact: e.g., 'Reduced build time by X%' or 'Fewer production incidents'"
  },
  {
    "category": "Behavioral",
    "difficulty": "Hard",
    "question": "You’re leading a team through a major tech stack migration. How do you manage risk and ensure knowledge transfer?",
    "hint": "Cover incremental rollout, metrics tracking, and documentation rituals"
  },
  {
    "category": "Role-specific",
    "difficulty": "Easy",
    "question": "When would you use GraphQL over REST for frontend-backend communication?",
    "hint": "Compare over-fetching, under-fetching, and schema flexibility"
  },
  {
    "category": "Role-specific",
    "difficulty": "Medium",
    "question": "Implement a performant infinite scroll list. How do you avoid memory leaks?",
    "hint": "Use virtualization (e.g., react-window) and cleanup detached DOM nodes"
  },
  {
    "category": "Role-specific",
    "difficulty": "Hard",
    "question": "Architect a design system supporting multiple products. How would you ensure consistency and theming?",
    "hint": "Discuss tokenization, component contracts, and monorepo tooling"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Easy",
    "question": "Your resume mentions Jest. How did you structure unit tests for your Vue.js components at ABC Inc?",
    "hint": "Reference mocking lifecycle hooks and testing emitted events"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Medium",
    "question": "You led a team for the e-commerce dashboard. How did you enforce code quality in a collaborative codebase?",
    "hint": "Detail PR review practices, linters (ESLint), and CI/CD checks"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Hard",
    "question": "Your resume shows a career gap in 2023. How did you use that time to upskill in frontend technologies?",
    "hint": "Highlight specific courses/certifications (e.g., advanced TypeScript) and personal projects"
  }
]

### 4. **6 Years Experience** (Senior-level)
[
  {
    "category": "Technical",
    "difficulty": "Easy",
    "question": "Describe how React Fiber improves rendering performance.",
    "hint": "Explain incremental rendering and task prioritization"
  },
  {
    "category": "Technical",
    "difficulty": "Medium",
    "question": "Evaluate strategies for bundle size reduction in a legacy Angular app. What tools would you use?",
    "hint": "Cover tree-shaking, lazy loading, and differential serving"
  },
  {
    "category": "Technical",
    "difficulty": "Hard",
    "question": "Design a framework-agnostic component library. How would you handle cross-framework compatibility?",
    "hint": "Discuss Web Components, shadow DOM, and framework wrappers (e.g., React/Vue adapters)"
  },
  {
    "category": "Behavioral",
    "difficulty": "Easy",
    "question": "How do you align frontend architecture decisions with long-term business goals?",
    "hint": "Link tech choices (e.g., SSR) to KPIs like conversion rates or SEO rankings"
  },
  {
    "category": "Behavioral",
    "difficulty": "Medium",
    "question": "As a tech lead, how would you handle a team member consistently missing deadlines?",
    "hint": "Outline empathetic 1:1s, root-cause analysis, and mentorship plans"
  },
  {
    "category": "Behavioral",
    "difficulty": "Hard",
    "question": "You’re asked to cut frontend team size by 30% while maintaining velocity. What’s your action plan?",
    "hint": "Focus on automation, removing low-impact features, and upskilling"
  },
  {
    "category": "Role-specific",
    "difficulty": "Easy",
    "question": "Define BFF (Backend for Frontend) pattern. When is it beneficial?",
    "hint": "Describe aggregating microservices and tailoring data to UI needs"
  },
  {
    "category": "Role-specific",
    "difficulty": "Medium",
    "question": "Implement A/B testing for a checkout flow rollout. How would you ensure statistical validity?",
    "hint": "Cover cohort isolation, metric selection (e.g., CVR), and significance testing"
  },
  {
    "category": "Role-specific",
    "difficulty": "Hard",
    "question": "Propose a migration from REST to GraphQL for an enterprise-scale app. How would you phase it?",
    "hint": "Discuss schema stitching, gradual rollout, and client co-existence strategies"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Easy",
    "question": "Your resume lists Webpack optimizations. What loaders/plugins did you use for bundle splitting?",
    "hint": "Name specific tools like SplitChunksPlugin or MiniCssExtractPlugin"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Medium",
    "question": "You mention 'CI/CD pipelines' in your skills. How did you automate frontend testing/deployment at XYZ Corp?",
    "hint": "Detail stages like linting, visual regression tests, and canary releases"
  },
  {
    "category": "Resume-specific",
    "difficulty": "Hard",
    "question": "Your resume shows 3 job changes in 4 years. How did each move advance your technical leadership capabilities?",
    "hint": "Connect role transitions to expanded scope (e.g., mentoring to architect)"
  }
]
'''
